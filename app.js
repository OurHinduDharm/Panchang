    ...
    if(niwas === "मृत्युलोक"){
      return {
        text:
          ...
          `आवश्यक कार्य हो तो भद्रा के अंग और अन्य मुहूर्त-विचार भी देखें।`,
        type:"avoid"
      };
    }
    ...
    if(niwas === "स्वर्ग"){
      return {
        text:
          `🟢 भद्रा चल रही है` +
          `${partName ? ` — वर्तमान अंग: ${partName}` : ""}। ` +
          `परंपरागत भद्रा-विचार में स्वर्गवासी भद्रा को पृथ्वी पर सामान्यतः शुभ फलदायिनी माना जाता है; ` +
    ...
    if(niwas === "पाताल"){
      return {
        text:
          `🟢 भद्रा चल रही है` +
          `${partName ? ` — वर्तमान अंग: ${partName}` : ""}। ` +
          `परंपरागत भद्रा-विचार में पातालवासी भद्रा को धनागम एवं शुभ फल से संबद्ध माना जाता है; ` +
          `फिर भी विशेष मांगलिक कार्य के लिए संपूर्ण मुहूर्त देखना उचित है।`,
        type:"neutral"
      };
    }
